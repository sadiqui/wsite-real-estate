            ...
            <div class="row">
                <div class="col-md-12 col-lg-8">
                    <div class="title-single-box">
                        <h1 class="title-single" style="color:#202c8f;">Contact US</h1>
                        <span class="color-text-a">Have questions or inquiries? We'd love to hear from you.
                            <br>Please fill
                            out the form below, and
                            we'll get back to you as soon as possible.</span>
                    </div>
                </div>
                ...
                <div class="col-sm-12">
                    <div class="contact-map box">
                        <div id="map" class="contact-map">
                            <iframe
                                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d13304.671159986465!2d-7.662186026573178!3d33.52302290739672!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xda62d0e41aa64bb%3A0x3cd11abb21bcec!2sCasa%20Nearshore!5e0!3m2!1sen!2sus!4v1703885255845!5m2!1sen!2sus"
                        ...
                        <div class="col-md-5 section-md-t3">
                            <div class="icon-box section-b2">
                                <div class="icon-box-icon">
                                    <span class="ion-ios-paper-plane" style="color:#202c8f;"></span>
                                </div>
                                <div class="icon-box-content table-cell">
                                    <div class="icon-box-title">
                                        <h4 class="icon-title" style="color:#202c8f;">Say Hello</h4>
                                    </div>
                                    <div class="icon-box-content">
                                        ...
                                        <p class="mb-1">Phone.
                                            <span class="color-a">+212 6 56 94 52 34</span>
                                        </p>
                                    </div>
                                </div>
                            </div>
                            <div class="icon-box section-b2">
                                <div class="icon-box-icon">
                                    <span class="ion-ios-pin" style="color:#202c8f;"></span>
                                </div>
                                <div class="icon-box-content table-cell">
                                    <div class="icon-box-title">
                                        <h4 class="icon-title" style="color:#202c8f;">Find us in</h4>
                                    </div>
                                    <div class="icon-box-content">
                                        <p class="mb-1">
                                            Casablanca, Nearshore 10036,
                                            <br>
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div class="icon-box">
                                <div class="icon-box-icon">
                                    <span class="ion-ios-redo" style="color:#202c8f;"></span>
                                </div>
                                <div class="icon-box-content table-cell">
                                    <div class="icon-box-title">
                                        <h4 class="icon-title" style="color:#202c8f;">Social networks</h4>
                                    </div>
                                    <div class="icon-box-content">
                                        <div class="socials-footer">
                                            <ul class="list-inline">
                                                <li class="list-inline-item">
                                                    <a href="#" class="link-one" style="color:#202c8f;">
